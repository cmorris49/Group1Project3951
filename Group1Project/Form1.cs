...
namespace Group1Project
{
    ...
    public partial class Form1 : Form
    {
        ...
        /// <summary>
        /// Genrate the tournament bracket when the 'Generate Bracket' toolbar button is clicked, ensuring that the tournament is valid before attempting to generate the bracket. 
        /// If the tournament is valid, it calls the GenerateBracket method on the current tournament and displays a success message. If there is an issue with generating the bracket (such as not having enough teams), it catches the exception and displays a warning message to the user.
        /// </summary>
        /// <param name="sender">Source of the event, typically the control that triggered the event.</param>
        /// <param name="e">The EventArgs instance containing the event data for the Click event.</param>
